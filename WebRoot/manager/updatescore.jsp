...
text-decoration:underline;
  ...
  <body bgcolor="#CCFFCC">
    ...
    while(rs.next()){
     %>
    <form action="servlet/m_updatescore?sid=<%=sid %>&cid=<%=cid %>" method="post" name="updateform" onSubmit="return isValid()">
        ...
        <center><a href="/stu_score_ms/manager/searchonescore.jsp?s_id=<%=sid %>">返回</a></center>
    </form>
  </body>
</html>
