...
text-decoration:underline;
  ...
  <body bgcolor="#CCFFCC"><br>
    ...
    double jpa=rs.getDouble("jpa");
     ...
     <td align="center"><%=jpa%>
     <td align="center"><a href="/stu_score_ms/manager/updatescore.jsp?s_id=<%=id%>&c_id=<%=cno %>" title="修改成绩">修改成绩</a></td> 
     </tr>
     <%} %>    
    </table></div>
    <br>
    <center><a href="/stu_score_ms/manager/showstudent.jsp"><font size=5>返回</font></a></center>
  </body>
</html>
