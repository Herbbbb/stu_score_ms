...
text-decoration:underline;
  ...
  <tr>
   ...
   <tr>
	...
	<td width=12% align=center><a href="servlet/m_selectcourse?cid=<%=cid %>&sid=<%=sid %>">选定</td>
  </tr>
  <%} %>
  </table>
  <br><br>
  <center><a href="/stu_score_ms/manager/showstucou.jsp"><font size=5>返回</font></a></center>
  </body>
</html>
