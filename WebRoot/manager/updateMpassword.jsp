...
<html>
  <head>
    ...
    <title>My JSP 'updateMpassword.jsp' starting page</title>
  ...
  <body bgcolor="#CCFFCC">
   ...
   <br>
   <center><font size=6 color="blue" face="华文行楷">修改密码</font></center><br>
   <form name="form1" method="post" action="servlet/updateMpassword">
